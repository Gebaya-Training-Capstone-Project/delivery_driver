...
class AccountSettingsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double screenWidth = MediaQuery.of(context).size.width;
    double availableHeight = screenHeight-110;
    Image arrowIcon = Image.asset('assets/icons/arrow-right.png', width: 16, height: 16);
    return Container(
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                SettingsItem(
                  title: 'Personal Info',
                  leading: Image.asset('assets/icons/PersonalInfo.png', width: 16, height: 16),
                  trailing: arrowIcon,
                ),
                SettingsItem(
                  title: 'Address Location',
                  leading: Image.asset('assets/icons/Adress.png', width: 16, height: 16),
                  trailing: arrowIcon,
                ),
                SettingsItem(
                  title: 'Payment',
                  leading: Image.asset('assets/icons/payment.png', width: 16, height: 16),
                  trailing: arrowIcon,
                ),
                SettingsItem(
                  title: 'Privacy Policy',
                  leading: Image.asset('assets/icons/privacy.png', width: 16, height: 16),
                  trailing: arrowIcon,
                ),
                SettingsItem(
                  title: 'Help',
                  leading: Image.asset('assets/icons/help.png', width: 16, height: 16),
                  trailing: arrowIcon,
                ),
              ],
            ),
